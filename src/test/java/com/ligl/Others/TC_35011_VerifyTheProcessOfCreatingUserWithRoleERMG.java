...
public class TC_35011_VerifyTheProcessOfCreatingUserWithRoleERMG extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData")
    public void TC_35011_VerifyTheProcessOfCreatingUserWithRoleERMG(Hashtable<String,String> data) throws Exception {
        try {
            ...
            session.log_Error("VerifyTheProcessOfCreatingUserWithRoleERMG Failed");
            throw new Exception("VerifyTheProcessOfCreatingUserWithRoleERMG Failed", ex);
        }finally {
            session.end();
        }
    }
