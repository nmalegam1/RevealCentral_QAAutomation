...
public class TC_44340_VerifyApprovingCaseDualApprovalEitherTypeFirstOneApproved extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "CaseManagement")
    public void TC_44340_VerifyApprovingCaseDualApprovalEitherTypeFirstOneApproved(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("TC_44340_VerifyApprovingCaseDualApprovalEitherTypeFirstOneApproved Failed");
            throw new Exception("TC_44340_VerifyApprovingCaseDualApprovalEitherTypeFirstOneApproved Failed", ex);
        } finally {
            session.end();
        }
    }
