...
public class VerifyApprovingCaseDualApprovalTypeFirstOneApproved_Test extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData")
    public void VerifyApprovingCaseDualApprovalTypeFirstOneApproved_Test(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("VerifyApprovingCaseDualApprovalTypeFirstOneApproved_Test Failed");
            throw new Exception("VerifyApprovingCaseDualApprovalTypeFirstOneApproved_Test Failed", ex);
        } finally {
            session.end();
        }
    }
