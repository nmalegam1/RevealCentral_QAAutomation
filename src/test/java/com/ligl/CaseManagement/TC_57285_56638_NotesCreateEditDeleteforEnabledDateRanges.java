    ...
    public void TC_57285_56638_NotesCreateEditDeleteforEnabledDateRanges(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            ILiglPage page = new LaunchPage()
                    ...
                    .validateEnableAndDisableDateRanges(data.get("DRStatus"))
                    .enabledDateRangeNotesClick(data.get("DRName"))
            ...
            session.log_Error("TC_57285_56638_NotesCreateEditDeleteforEnabledDateRanges Failed");
            throw new Exception("TC_57285_56638_NotesCreateEditDeleteforEnabledDateRanges Failed", ex);
        } finally {
            session.end();
        }
    }
