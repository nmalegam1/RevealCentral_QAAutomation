...
public class Initiate_AutoProcess_ForRecordUpto_RelativityProcessing_SmokeTest_ServiceProvider extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "Smoke")
    public void Initiate_AutoProcess_ForRecordUpto_RelativityProcessing_SmokeTest_ServiceProvider(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("Initiate_AutoProcess_ForRecordUpto_RelativityProcessing_SmokeTest_ServiceProvider Failed");
            throw new Exception("Initiate_AutoProcess_ForRecordUpto_RelativityProcessing_SmokeTest_ServiceProvider Failed", ex);
        } finally {
            session.end();
        }
    }
