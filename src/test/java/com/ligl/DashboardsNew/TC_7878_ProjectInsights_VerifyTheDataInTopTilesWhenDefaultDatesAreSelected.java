...
public class TC_7878_ProjectInsights_VerifyTheDataInTopTilesWhenDefaultDatesAreSelected extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void TC_7878_ProjectInsights_VerifyTheDataInTopTilesWhenDefaultDatesAreSelected(Hashtable<String,String> data) throws Exception {
        try{
