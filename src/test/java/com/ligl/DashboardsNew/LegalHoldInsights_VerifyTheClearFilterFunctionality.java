...
public class LegalHoldInsights_VerifyTheClearFilterFunctionality extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void LegalHoldInsights_VerifyTheClearFilterFunctionality(Hashtable<String,String> data) throws Exception {
         testCaseId="2453863";
        try{
