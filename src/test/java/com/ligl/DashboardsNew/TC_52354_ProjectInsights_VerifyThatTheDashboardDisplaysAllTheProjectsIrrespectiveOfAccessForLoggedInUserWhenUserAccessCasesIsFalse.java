...
public class TC_52354_ProjectInsights_VerifyThatTheDashboardDisplaysAllTheProjectsIrrespectiveOfAccessForLoggedInUserWhenUserAccessCasesIsFalse extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void TC_52354_ProjectInsights_VerifyThatTheDashboardDisplaysAllTheProjectsIrrespectiveOfAccessForLoggedInUserWhenUserAccessCasesIsFalse(Hashtable<String,String> data) throws Exception {
        try{
