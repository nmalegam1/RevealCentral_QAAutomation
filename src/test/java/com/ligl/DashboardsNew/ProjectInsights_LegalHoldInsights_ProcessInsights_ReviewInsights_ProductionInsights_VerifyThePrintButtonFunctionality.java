...
public class ProjectInsights_LegalHoldInsights_ProcessInsights_ReviewInsights_ProductionInsights_VerifyThePrintButtonFunctionality extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void ProjectInsights_LegalHoldInsights_ProcessInsights_ReviewInsights_ProductionInsights_VerifyThePrintButtonFunctionality(Hashtable<String,String> data) throws Exception {
         testCaseId="2453904";
        try{
