...
public class TC_28289_GlobalInsights_VerifyTheDataInTopTilesWhenProjectContextIsNotSet extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void TC_28289_GlobalInsights_VerifyTheDataInTopTilesWhenProjectContextIsNotSet(Hashtable<String,String> data) throws Exception {
        try{
