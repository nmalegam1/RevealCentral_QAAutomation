...
public class ProcessInsigts_VerifyTheDataInDashboardWhenFromAndToDatesAreAdjusted extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData",description = "Dashboards")
    public void ProcessInsigts_VerifyTheDataInDashboardWhenFromAndToDatesAreAdjusted(Hashtable<String, String> data) throws Exception {
         testCaseId="2453903";
        try {
