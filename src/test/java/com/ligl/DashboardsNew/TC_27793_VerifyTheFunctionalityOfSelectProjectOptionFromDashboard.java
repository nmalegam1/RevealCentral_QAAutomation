...
public class TC_27793_VerifyTheFunctionalityOfSelectProjectOptionFromDashboard extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void TC_27793_VerifyTheFunctionalityOfSelectProjectOptionFromDashboard(Hashtable<String,String> data) throws Exception {
        try{
