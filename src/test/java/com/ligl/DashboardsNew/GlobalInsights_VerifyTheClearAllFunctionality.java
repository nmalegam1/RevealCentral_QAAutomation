...
public class GlobalInsights_VerifyTheClearAllFunctionality extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void GlobalInsights_VerifyTheClearAllFunctionality(Hashtable<String,String> data) throws Exception {
         testCaseId="2453897";
        try{
