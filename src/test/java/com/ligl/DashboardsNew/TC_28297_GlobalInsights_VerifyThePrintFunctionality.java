...
public class TC_28297_GlobalInsights_VerifyThePrintFunctionality extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void TC_28297_GlobalInsights_VerifyThePrintFunctionality(Hashtable<String,String> data) throws Exception {
        try{
