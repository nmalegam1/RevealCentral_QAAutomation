...
public class ProcessInsights_VerifyTheClearFilterFunctionlaity extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void ProcessInsights_VerifyTheClearFilterFunctionlaity(Hashtable<String,String> data) throws Exception {
         testCaseId="2453856";
        try{
