...
public class TC_28570_VerifyTheFunctionalityOfClearProjectOptionFromDashboard extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void TC_28570_VerifyTheFunctionalityOfClearProjectOptionFromDashboard(Hashtable<String,String> data) throws Exception {
        try{
