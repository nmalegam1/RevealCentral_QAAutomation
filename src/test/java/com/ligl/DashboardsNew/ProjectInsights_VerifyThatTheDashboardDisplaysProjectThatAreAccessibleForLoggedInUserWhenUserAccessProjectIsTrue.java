...
public class ProjectInsights_VerifyThatTheDashboardDisplaysProjectThatAreAccessibleForLoggedInUserWhenUserAccessProjectIsTrue extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description = "Dashboards")
    public void ProjectInsights_VerifyThatTheDashboardDisplaysProjectThatAreAccessibleForLoggedInUserWhenUserAccessProjectIsTrue(Hashtable<String,String> data) throws Exception {
         testCaseId="2453905";
        try{
