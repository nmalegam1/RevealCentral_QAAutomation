...
public class TC_GSuite_PreservationWithSingleLHWithDateRangeAndKeywordMultiple extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData" ,description = "DataManagement")
    public void TC_GSuite_PreservationWithSingleLHWithDateRangeAndKeywordMultiple(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("TC_GSuite_PreservationWithSingleLHWithDateRangeAndKeywordMultiple Failed");
            throw new Exception("TC_GSuite_PreservationWithSingleLHWithDateRangeAndKeywordMultiple Failed", ex);
        } finally {
            session.end();
        }
    }
