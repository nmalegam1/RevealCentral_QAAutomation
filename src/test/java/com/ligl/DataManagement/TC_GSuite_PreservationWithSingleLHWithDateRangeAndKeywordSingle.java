...
public class TC_GSuite_PreservationWithSingleLHWithDateRangeAndKeywordSingle extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData" ,description = "DataManagement")
    public void TC_GSuite_PreservationWithSingleLHWithDateRangeAndKeywordSingle(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("TC_GSuite_PreservationWithSingleLHWithDateRangeAndKeywordSingle Failed");
            throw new Exception("TC_GSuite_PreservationWithSingleLHWithDateRangeAndKeywordSingle Failed", ex);
        } finally {
            session.end();
        }
    }
