...
public class TC_GSuite_PreservationWithOutLegalHold extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData" ,description = "DataManagement")
    public void TC_GSuite_PreservationWithOutLegalHold(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            throw new Exception("TC_GSuite_PreservationWithOutLegalHold Failed", ex);
        } finally {
            session.end();
        }
    }
