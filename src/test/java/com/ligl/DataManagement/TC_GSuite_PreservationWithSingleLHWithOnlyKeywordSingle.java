...
public class TC_GSuite_PreservationWithSingleLHWithOnlyKeywordSingle extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData" ,description = "DataManagement")
    public void TC_GSuite_PreservationWithSingleLHWithOnlyKeywordSingle(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("TC_GSuite_PreservationWithSingleLHWithOnlyKeywordSingle Failed");
            throw new Exception("TC_GSuite_PreservationWithSingleLHWithOnlyKeywordSingle Failed", ex);
        } finally {
            session.end();
        }
    }
