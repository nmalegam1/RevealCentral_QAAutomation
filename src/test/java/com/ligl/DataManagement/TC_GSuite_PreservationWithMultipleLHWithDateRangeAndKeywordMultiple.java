...
public class TC_GSuite_PreservationWithMultipleLHWithDateRangeAndKeywordMultiple extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData" ,description = "DataManagement")
    public void TC_GSuite_PreservationWithMultipleLHWithDateRangeAndKeywordMultiple(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("TC_GSuite_PreservationWithMultipleLHWithDateRangeAndKeywordMultiple Failed");
            throw new Exception("TC_GSuite_PreservationWithMultipleLHWithDateRangeAndKeywordMultiple Failed", ex);
        } finally {
            session.end();
        }
    }
