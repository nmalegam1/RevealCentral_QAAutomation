...
public class TC_GSuite_PreservationWithSingleLHWithOnlyDateRanges extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData" , description = "DataManagement")
    public void TC_GSuite_PreservationWithSingleLHWithOnlyDateRanges(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("TC_GSuite_PreservationWithSingleLHWithOnlyDateRanges Failed");
            throw new Exception("TC_GSuite_PreservationWithSingleLHWithOnlyDateRanges Failed", ex);
        } finally {
            session.end();
        }
    }
