...
public class TC_GSuite_PreservationWithMultipleLHWithOnlyKeywordsMultiple extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData" , description = "DataManagement")
    public void TC_GSuite_PreservationWithMultipleLHWithOnlyKeywordsMultiple(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("TC_GSuite_PreservationWithMultipleLHWithOnlyKeywordsMultiple Failed");
            throw new Exception("TC_GSuite_PreservationWithMultipleLHWithOnlyKeywordsMultiple Failed", ex);
        } finally {
            session.end();
        }
    }
