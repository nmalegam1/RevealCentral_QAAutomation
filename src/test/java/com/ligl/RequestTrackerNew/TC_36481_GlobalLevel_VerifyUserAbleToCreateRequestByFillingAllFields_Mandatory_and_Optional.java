...
public class TC_36481_GlobalLevel_VerifyUserAbleToCreateRequestByFillingAllFields_Mandatory_and_Optional extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData", description = "RequestTracker")
    public void TC_36481_GlobalLevel_VerifyUserAbleToCreateRequestByFillingAllFields_Mandatory_and_Optional(Hashtable<String,String> data) throws Exception {
        try{
