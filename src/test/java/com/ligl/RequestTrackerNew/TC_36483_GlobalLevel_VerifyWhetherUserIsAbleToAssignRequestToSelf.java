...
public class TC_36483_GlobalLevel_VerifyWhetherUserIsAbleToAssignRequestToSelf extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description="RequestTracker")
    public void TC_36483_GlobalLevel_VerifyWhetherUserIsAbleToAssignRequestToSelf(Hashtable<String,String> data) throws Exception {
        try{
            ...
            session.log_Error("TC_36483_GlobalLevel_VerifyWhetherUserIsAbleToAssignRequestToSelf Failed");
            throw new Exception("Exception in TC_36483_GlobalLevel_VerifyWhetherUserIsAbleToAssignRequestToSelf", ex);
        }finally {
            session.end();
        }
    }
