...
public class GlobalLevel_VerifyWhetherNoEditIsAllowedWhenaRequestIsInClosedState extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData", description = "RequestTracker")
    public void GlobalLevel_VerifyWhetherNoEditIsAllowedWhenaRequestIsInClosedState(Hashtable<String,String> data) throws Exception {
         testCaseId="2453036";
        try{
