...
public class TC_36651_GlobalLevel_VerifyWhetherTopLevelStatsAreUpdatedForTotal_New_Inprogress_ClosedRequests extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData", description = "RequestTracker")
    public void TC_36651_GlobalLevel_VerifyWhetherTopLevelStatsAreUpdatedForTotal_New_Inprogress_ClosedRequests(Hashtable<String,String> data) throws Exception {
        try{
