...
public class GlobalLevel_VerifyWhetherUserIsAbleToAssignRequestToSelf extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData",description="RequestTracker")
    public void GlobalLevel_VerifyWhetherUserIsAbleToAssignRequestToSelf(Hashtable<String,String> data) throws Exception {
         testCaseId="2453000";
        try{
