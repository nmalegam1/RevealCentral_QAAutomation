...
public class GlobalLevel_CheckWhetherDropdownsAreSearchableInCreateAndEditOfRequest extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData", description = "RequestTracker")
    public void GlobalLevel_CheckWhetherDropdownsAreSearchableInCreateAndEditOfRequest(Hashtable<String,String> data) throws Exception {
        testCaseId="2453040";
        try{
