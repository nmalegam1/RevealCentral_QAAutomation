...
public class TC_26844_GlobalLevel_VerifyWhetherRequestCanBeAssignedToUser extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData", description = "RequestTracker")
    public void TC_26844_GlobalLevel_VerifyWhetherRequestCanBeAssignedToUser(Hashtable<String,String> data) throws Exception {
        try{
            ...
            session.log_Error("TC_26844_GlobalLevel_VerifyWhetherRequestCanBeAssignedToUser Failed");
            throw new Exception("Exception in TC_26844_GlobalLevel_VerifyWhetherRequestCanBeAssignedToUser", ex);
        }finally {
            session.end();
        }
    }
