...
public class GlobalLevel_VerifyWhetherRequestCanBeAssignedToUser extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData", description = "RequestTracker")
    public void GlobalLevel_VerifyWhetherRequestCanBeAssignedToUser(Hashtable<String,String> data) throws Exception {
         testCaseId="2453032";
        try{
