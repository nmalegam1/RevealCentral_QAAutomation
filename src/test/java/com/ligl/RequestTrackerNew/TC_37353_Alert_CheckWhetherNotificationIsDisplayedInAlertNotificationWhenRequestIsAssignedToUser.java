...
public class TC_37353_Alert_CheckWhetherNotificationIsDisplayedInAlertNotificationWhenRequestIsAssignedToUser extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class , dataProvider = "getData", description = "RequestTracker")
    public void TC_37353_Alert_CheckWhetherNotificationIsDisplayedInAlertNotificationWhenRequestIsAssignedToUser(Hashtable<String,String> data) throws Exception {
        try{
