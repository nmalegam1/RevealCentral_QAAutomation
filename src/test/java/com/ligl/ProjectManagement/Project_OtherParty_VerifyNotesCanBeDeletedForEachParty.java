...
public class Project_OtherParty_VerifyNotesCanBeDeletedForEachParty extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void Project_OtherParty_VerifyNotesCanBeDeletedForEachParty(Hashtable<String, String> data) throws Exception {
        testCaseId="2453364";
        try {
