...
public class VerifyProjectApprovalProcessByChoosingApprovalTypeAsDualEither_WhenApprover1_RejectsAndApprover2_ApprovesTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyProjectApprovalProcessByChoosingApprovalTypeAsDualEither_WhenApprover1_RejectsAndApprover2_ApprovesTheProject(Hashtable<String, String> data) throws Exception {
         testCaseId="2453434";
        try {
