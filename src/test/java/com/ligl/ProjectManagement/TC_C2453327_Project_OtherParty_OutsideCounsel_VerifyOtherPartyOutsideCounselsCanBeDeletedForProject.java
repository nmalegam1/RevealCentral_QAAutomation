...
public class TC_C2453327_Project_OtherParty_OutsideCounsel_VerifyOtherPartyOutsideCounselsCanBeDeletedForProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_C2453327_Project_OtherParty_OutsideCounsel_VerifyOtherPartyOutsideCounselsCanBeDeletedForProject(Hashtable<String, String> data) throws Exception {
