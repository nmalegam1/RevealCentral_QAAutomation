...
public class TC_62366_VerifyUserShouldBeAbleToSendScopeItemsForApprovalByClickingSelectAllAboveEachGridInSendForApprovalPopup extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_62366_VerifyUserShouldBeAbleToSendScopeItemsForApprovalByClickingSelectAllAboveEachGridInSendForApprovalPopup(Hashtable<String, String> data) throws Exception {
