...
public class VerifyRevokeButtonFunctionalityWhenProjectIsInPendingApprovalState extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData",description = "ProjectManagement")
    public void VerifyRevokeButtonFunctionalityWhenProjectIsInPendingApprovalState(Hashtable<String, String> data) throws Exception {
        testCaseId="2453470";
        try {
