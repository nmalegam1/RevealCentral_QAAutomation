...
public class VerifyUserIsAbleToViewCaseDocumentInNewTab extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyUserIsAbleToViewCaseDocumentInNewTab(Hashtable<String, String> data) throws Exception {
        testCaseId="2453457";
        try {
