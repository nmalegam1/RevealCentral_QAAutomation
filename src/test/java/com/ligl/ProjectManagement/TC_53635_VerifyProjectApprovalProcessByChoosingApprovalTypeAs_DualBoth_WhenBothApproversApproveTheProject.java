...
public class TC_53635_VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenBothApproversApproveTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_53635_VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenBothApproversApproveTheProject(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            session.log_Error("TC_53635_VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenBothApproversApproveTheProject Failed");
            throw new Exception("TC_53635_VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenBothApproversApproveTheProject Failed", ex);
        } finally {
            session.end();
        }
    }
