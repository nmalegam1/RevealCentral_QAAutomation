...
public class VerifyProjectApprovalProcessByChoosingApprovalTypeAsDualEitherWhenBothApproversApproveTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyProjectApprovalProcessByChoosingApprovalTypeAsDualEitherWhenBothApproversApproveTheProject(Hashtable<String, String> data) throws Exception {
        testCaseId="2453335";
        try {
