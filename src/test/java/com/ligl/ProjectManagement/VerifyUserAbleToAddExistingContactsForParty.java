...
public class VerifyUserAbleToAddExistingContactsForParty extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyUserAbleToAddExistingContactsForParty(Hashtable<String, String> data) throws Exception {
        testCaseId="2453451";
        try {
