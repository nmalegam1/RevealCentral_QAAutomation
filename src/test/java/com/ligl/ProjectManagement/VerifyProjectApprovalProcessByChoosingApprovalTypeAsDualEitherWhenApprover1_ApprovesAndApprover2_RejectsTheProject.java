...
public class VerifyProjectApprovalProcessByChoosingApprovalTypeAsDualEitherWhenApprover1_ApprovesAndApprover2_RejectsTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyProjectApprovalProcessByChoosingApprovalTypeAsDualEitherWhenApprover1_ApprovesAndApprover2_RejectsTheProject(Hashtable<String, String> data) throws Exception {
         testCaseId="2453433";
        try {
