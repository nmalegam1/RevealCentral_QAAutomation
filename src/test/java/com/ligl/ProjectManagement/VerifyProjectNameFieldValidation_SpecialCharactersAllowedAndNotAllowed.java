...
public class VerifyProjectNameFieldValidation_SpecialCharactersAllowedAndNotAllowed extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyProjectNameFieldValidation_SpecialCharactersAllowedAndNotAllowed(Hashtable<String, String> data) throws Exception {
         testCaseId="2453395";
        try {
