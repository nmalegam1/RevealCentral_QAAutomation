...
public class VerifyUserAbleToCreateNewLawfirmAndCreateCounselForNewlyCreatedLawfirm extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyUserAbleToCreateNewLawfirmAndCreateCounselForNewlyCreatedLawfirm(Hashtable<String, String> data) throws Exception {
        testCaseId="2453450";
        try {
