...
public class VerifyThatAllFieldsIncludingAdditionalFieldsAreDisplayingWithRespectiveValuesInProjectSummaryPage extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyThatAllFieldsIncludingAdditionalFieldsAreDisplayingWithRespectiveValuesInProjectSummaryPage(Hashtable<String, String> data) throws Exception {
         testCaseId="2453399";
        try {
