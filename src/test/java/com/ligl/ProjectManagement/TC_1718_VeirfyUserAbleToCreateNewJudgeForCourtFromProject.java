...
public class TC_1718_VeirfyUserAbleToCreateNewJudgeForCourtFromProject extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_1718_VeirfyUserAbleToCreateNewJudgeForCourtFromProject(Hashtable<String, String> data) throws Exception {
        try {
