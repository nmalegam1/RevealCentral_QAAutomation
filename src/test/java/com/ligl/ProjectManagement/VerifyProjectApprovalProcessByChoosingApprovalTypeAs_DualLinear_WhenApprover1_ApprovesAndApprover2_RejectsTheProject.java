...
public class VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualLinear_WhenApprover1_ApprovesAndApprover2_RejectsTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualLinear_WhenApprover1_ApprovesAndApprover2_RejectsTheProject(Hashtable<String, String> data) throws Exception {
         testCaseId="2453436";
        try {
