...
public class VerifyNotesCanBeUpdatedForEachInhouseCounsel extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData",description ="ProjectManagement")
    public void VerifyNotesCanBeUpdatedForEachInhouseCounsel(Hashtable<String, String> data) throws Exception {
         testCaseId="2453358";
        try {
