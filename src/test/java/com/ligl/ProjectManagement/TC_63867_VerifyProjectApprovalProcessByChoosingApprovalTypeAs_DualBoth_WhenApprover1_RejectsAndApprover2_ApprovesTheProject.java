...
public class TC_63867_VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenApprover1_RejectsAndApprover2_ApprovesTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_63867_VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenApprover1_RejectsAndApprover2_ApprovesTheProject(Hashtable<String, String> data) throws Exception {
