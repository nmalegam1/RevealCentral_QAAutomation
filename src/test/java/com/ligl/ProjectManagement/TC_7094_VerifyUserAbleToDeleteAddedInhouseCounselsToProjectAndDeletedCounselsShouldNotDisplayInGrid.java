...
public class TC_7094_VerifyUserAbleToDeleteAddedInhouseCounselsToProjectAndDeletedCounselsShouldNotDisplayInGrid extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_7094_VerifyUserAbleToDeleteAddedInhouseCounselsToProjectAndDeletedCounselsShouldNotDisplayInGrid(Hashtable<String, String> data) throws Exception {
