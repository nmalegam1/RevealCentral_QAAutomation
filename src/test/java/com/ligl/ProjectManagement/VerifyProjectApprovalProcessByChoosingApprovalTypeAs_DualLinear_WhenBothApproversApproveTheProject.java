...
public class VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualLinear_WhenBothApproversApproveTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualLinear_WhenBothApproversApproveTheProject(Hashtable<String, String> data) throws Exception {
         testCaseId="2453336";
        try {
