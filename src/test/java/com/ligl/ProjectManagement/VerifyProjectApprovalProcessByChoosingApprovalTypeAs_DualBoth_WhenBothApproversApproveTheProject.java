...
public class VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenBothApproversApproveTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenBothApproversApproveTheProject(Hashtable<String, String> data) throws Exception {
         testCaseId="2453334";
        try {
