    ...
    public void TC_62312_VerifyColumnNamesAndColumnDataInProjectListGridWhenNUIXprocessingConfiguredCSFalse(Hashtable<String, String> data) throws Exception {
        ...
        try {
            ...
            ILiglPage page = new LaunchPage()
                    ...
                    .searchForTheRequiredColumnsThroughChooseColumn(data.get("INGESTION"))
                    .performClearActionInSearchBarInChooseColumn()
                    .searchForTheRequiredColumnsThroughChooseColumn(data.get("HOSTING"));



        } catch (Exception ex) {
            session.log_Error("TC_62312_VerifyColumnNamesAndColumnDataInProjectListGridWhenNUIXprocessingConfiguredCSFalse Failed");
            throw new Exception("TC_62312_VerifyColumnNamesAndColumnDataInProjectListGridWhenNUIXprocessingConfiguredCSFalse Failed", ex);
        } finally {
            session.end();
        }
    }
