...
public class VerifyUserAbleToCreateInhouseCounselsFromProjectForPartyType_Enterprise_AndAbleToAddExistingInhouseCounselsToProjectOnlyIfPartyTypeIs_Enterprise extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyUserAbleToCreateInhouseCounselsFromProjectForPartyType_Enterprise_AndAbleToAddExistingInhouseCounselsToProjectOnlyIfPartyTypeIs_Enterprise(Hashtable<String, String> data) throws Exception {
        testCaseId="2453453";
        try {
