...
public class TC_63863_VerifyProjectApprovalProcessByChoosingApprovalTypeAsDualEitherWhenBothTheApproversRejectsTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_63863_VerifyProjectApprovalProcessByChoosingApprovalTypeAsDualEitherWhenBothTheApproversRejectsTheProject(Hashtable<String, String> data) throws Exception {
