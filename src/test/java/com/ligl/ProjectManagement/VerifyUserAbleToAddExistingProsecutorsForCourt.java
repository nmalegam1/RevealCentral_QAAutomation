...
public class VerifyUserAbleToAddExistingProsecutorsForCourt extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyUserAbleToAddExistingProsecutorsForCourt(Hashtable<String, String> data) throws Exception {
        testCaseId="2453446";
