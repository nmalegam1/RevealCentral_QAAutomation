...
public class TC_63868_VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenBothApproversRejectsTheProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_63868_VerifyProjectApprovalProcessByChoosingApprovalTypeAs_DualBoth_WhenBothApproversRejectsTheProject(Hashtable<String, String> data) throws Exception {
