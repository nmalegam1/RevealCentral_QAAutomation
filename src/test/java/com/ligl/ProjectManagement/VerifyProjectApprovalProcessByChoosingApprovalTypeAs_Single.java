...
public class VerifyProjectApprovalProcessByChoosingApprovalTypeAs_Single extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyProjectApprovalProcessByChoosingApprovalTypeAs_Single(Hashtable<String, String> data) throws Exception {
        testCaseId="2453474";
        try {
