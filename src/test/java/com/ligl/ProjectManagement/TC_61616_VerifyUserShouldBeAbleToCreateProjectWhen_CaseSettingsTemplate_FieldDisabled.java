...
public class TC_61616_VerifyUserShouldBeAbleToCreateProjectWhen_CaseSettingsTemplate_FieldDisabled extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_61616_VerifyUserShouldBeAbleToCreateProjectWhen_CaseSettingsTemplate_FieldDisabled(Hashtable<String, String> data) throws Exception {
