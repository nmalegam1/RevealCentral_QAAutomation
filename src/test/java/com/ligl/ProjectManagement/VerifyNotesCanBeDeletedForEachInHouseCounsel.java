...
public class VerifyNotesCanBeDeletedForEachInHouseCounsel extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData",description ="ProjectManagement")
    public void VerifyNotesCanBeDeletedForEachInHouseCounsel(Hashtable<String, String> data) throws Exception {
