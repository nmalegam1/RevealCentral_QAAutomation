...
public class VerifyAddInhouseCounselButtonIsDisabledForPartyTypesOtherThan_Enterprise extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void VerifyAddInhouseCounselButtonIsDisabledForPartyTypesOtherThan_Enterprise(Hashtable<String, String> data) throws Exception {
        testCaseId="2453454";
        try {
