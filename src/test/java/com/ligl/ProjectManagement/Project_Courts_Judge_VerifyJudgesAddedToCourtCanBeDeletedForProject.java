...
public class Project_Courts_Judge_VerifyJudgesAddedToCourtCanBeDeletedForProject extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void Project_Courts_Judge_VerifyJudgesAddedToCourtCanBeDeletedForProject(Hashtable<String, String> data) throws Exception {
        testCaseId="2453283";
        try {
