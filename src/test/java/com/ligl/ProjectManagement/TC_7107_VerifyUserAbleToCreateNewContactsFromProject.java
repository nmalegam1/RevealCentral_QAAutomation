...
public class TC_7107_VerifyUserAbleToCreateNewContactsFromProject extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_7107_VerifyUserAbleToCreateNewContactsFromProject(Hashtable<String, String> data) throws Exception {
