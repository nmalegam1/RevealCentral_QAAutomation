...
public class TC_7100_VerifyUserAbleToDeleteOutsideCounselAddedToProjectAndDeletedCounselsShouldNotDisplayInGrid extends TestBase {

    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_7100_VerifyUserAbleToDeleteOutsideCounselAddedToProjectAndDeletedCounselsShouldNotDisplayInGrid(Hashtable<String, String> data) throws Exception {
