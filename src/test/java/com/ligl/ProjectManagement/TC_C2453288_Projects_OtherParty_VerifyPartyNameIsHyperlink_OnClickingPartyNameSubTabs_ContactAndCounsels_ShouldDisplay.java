...
public class TC_C2453288_Projects_OtherParty_VerifyPartyNameIsHyperlink_OnClickingPartyNameSubTabs_ContactAndCounsels_ShouldDisplay extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "ProjectManagement")
    public void TC_C2453288_Projects_OtherParty_VerifyPartyNameIsHyperlink_OnClickingPartyNameSubTabs_ContactAndCounsels_ShouldDisplay(Hashtable<String, String> data) throws Exception {
        try {
