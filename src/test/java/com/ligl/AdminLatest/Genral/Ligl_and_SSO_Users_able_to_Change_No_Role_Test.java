...
public class Ligl_and_SSO_Users_able_to_Change_No_Role_Test extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "Administration")
    public void Ligl_and_SSO_Users_able_to_Change_No_Role_Test(Hashtable<String, String> data) throws Exception {
        testCaseId="2453829";
        try {
            ...
            session.log_Error("TC28525_Ligl_and_SSO_Users_able_to_Change_No_Role_Test Failed");
            throw new Exception("TC28525_Ligl_and_SSO_Users_able_to_Change_No_Role_Test Failed", ex);
        } finally {
            session.end();
        }
    }
