...
public class Check_that_Alert_should_be_displayed_when_NoRole_to_logged_in_user_Test extends TestBase {
    @Test(dataProviderClass = TestDataProvider.class, dataProvider = "getData", description = "Administration")
    public void Check_that_Alert_should_be_displayed_when_NoRole_to_logged_in_user_Test(Hashtable<String, String> data) throws Exception {
        testCaseId="2453830";
        try {
