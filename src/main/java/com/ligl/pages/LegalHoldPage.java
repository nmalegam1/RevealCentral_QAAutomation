...
public class LegalHoldPage extends LiglBaseSessionPage {
    ...
    @FindBy(id="btn-cancellhnName")
    WebElement LHNCancelBtn;
    ...
    @FindBy(id = "lhc-notice-template-selection")
    ...
    @FindBy(id = "lhc-custodian-ques-template")
    ...
    @FindBy(xpath = "//div[@class='modal-content']//app-add-edit-lhn-date-range-key-words//mat-chip-list[@formcontrolname='KeyWords']//div")
    ...
    @FindBy(xpath = "//div[@class='modal-content']//app-add-edit-lhn-date-range-key-words//button[@id='add-edit-drkw-done-btn']")
    ...
    public ILiglPage createLHNAfterFirstLHNWith_KW_DR_AndCheckKW_DR_Disabled(String lhName1, String lhName2, String lhName3, String custTemp, String startDate, String endDate, String keyword, String NewtempName, String subject, String content) throws Exception {
        try {
            ...
            AddLHN.click();
            Thread.sleep(5000);
            NameOfTheLegalHold.sendKeys(lhName2);
            LHNNextBtn.click();
            Thread.sleep(2000);
            ChooseNoticeTemplateDrpDwn.click();
            Thread.sleep(2000);
    ...
    public ILiglPage verifyLHKWCreatedInFirstLHDisplayeingInLHsCreatedLater(String lhName1, String lhName2, String custTemp, String startDate, String endDate, String keyword) throws Exception {
        try {
            ...
            if (!b3)
                log_Info("Start date Field is Disabled");
            WebElement keyWordsForm = getCurrentDriver().findElement(By.xpath("//div[@class='modal-content']//app-add-edit-lhn-date-range-key-words//mat-chip-list[@formcontrolname='KeyWords']//div"));
            keyWordsForm.click();
            List<WebElement> listItem = keyWordsForm.findElements(By.xpath("//mat-chip"));
            for (int i = 0; i < listItem.size(); i++) {
                keyWordsForm.sendKeys(Keys.BACK_SPACE);
    ...
    public ILiglPage createNewLegalHoldWhenOnFlyIsFalse(String LegalHoldname, String CustodianTemplate, String CustodianQuestionaireTemplate, String StakeHolderTemplate, String StakeHolderQueTemplate, String startdate,String enddate,String keyword) throws Exception {
        try {
            ...
            enterNameOfTheLH(LegalHoldname);
            ...
            chooseCustodianQuestionnaireTemplate(CustodianQuestionaireTemplate);
            ...
            chooseStakeHolderTemplate(StakeHolderTemplate);
            getSession().log_Pass("Selected StakeHolder Template Drop Down");

            chooseStakeHolderQuestionnaireTemplate(StakeHolderQueTemplate);
    ...
    public ILiglPage editLegalHoldWhenOnFlyIsFalse(String EditedLegalHoldname, String CustodianQTemplate, String LHname) throws Exception {
        try {
           ...
           /* log_Info("secondSearch() is going to start");
            ...
            log_Info("Click on Name Of The Legal Hold");
            enterNameOfTheLH(EditedLegalHoldname);
            ...
            log_Info("Select Custodian Questionnaire Template Drop Down");
            chooseCustodianQuestionnaireTemplate(CustodianQTemplate);
    ...
    public ILiglPage enterCustodianNoticeTemplate(String CustodianTemplate) throws Exception {
        ...
        try {
            ...
            ChooseNoticeTemplateDrpDwn.click();
            Thread.sleep(3000);
            getCurrentDriver().findElement(By.xpath("//input[@placeholder='Search']")).sendKeys(CustodianTemplate);
            Thread.sleep(2000);
            getCurrentDriver().findElement(By.xpath("//input[@placeholder='Search']")).sendKeys(Keys.ENTER);
    ...
    public ILiglPage checkThatNewlyCreatedQuestionnaireIsDisplaying(String legalHoldName, String custodianNotice,
        ...
        try {
            ...
            getDriver().waitForelementToBeClickable(ChooseNoticeTemplateDrpDwn);
            ChooseNoticeTemplateDrpDwn.sendKeys(custodianNotice);
            wait(1);
            ChooseNoticeTemplateDrpDwn.sendKeys(Keys.ENTER);
            getDriver().waitForAngularRequestsToComplete();
            wait(2);
...
// Creation of Legal hold without filters DR & KW
    ...
    /**
     * Method to Save the Created/Edited LHN
     * @return
     * @throws Exception
     */
    public ILiglPage lhnSave()throws Exception{
        try{
           log_Info("lhnSave() Started");
            ...
            throw new Exception("Exception in lhnSave() ");
        }
    }

    /**
     * Method to create LHN with Mandatory fields
     * @param lhName
     * @param custTemp
     * @return
     * @throws Exception
    ...
    public ILiglPage addLHNWithMandatoryFields(String lhName, String custTemp)throws Exception{
        try{
            ...
            log_Error("addLHNWithMandatoryFields() is failed");
            throw new Exception("Exception in addLHNWithMandatoryFields() ");
        }
    }
    /**
     * Method to Cancel the Created/Edited LHN
     * @return
     * @throws Exception
     */
    public ILiglPage lhnCancel()throws Exception{
        try{
            log_Info("lhnCancel() Started");
            LHNCancelBtn.click();
            log_Pass("LHN Cancel button is clicked");
            return new LegalHoldPage();
        }catch (Exception ex){
            log_Error("lhnCancel() is failed");
            throw new Exception("Exception in lhnCancel() ");
        }
    }

    /**
     * Method to Click on OnFly Edit button and navigate to email templates
     * @return
     * @throws Exception
     */
    public ILiglPage lhnOnFlyEdit()throws Exception{
        try{
            log_Info("lhnOnFlyEdit() Started");
            OnFlyEdit.click();
            log_Info("LHN OnFly Edit button is clicked");
            getCurrentDriver().getCurrentUrl().contains("lhnemailtemplate");
            log_Pass("Navigated to LealHold Email Templated");

            return new LegalHoldPage();
        }catch (Exception ex){
            log_Error("lhnOnFlyEdit() is failed");
            throw new Exception("Exception in lhnOnFlyEdit() ");
        }
    }

    /**
     * Method to choose a Stake holder Template
     * @param StakeHolderTemplate
     * @return
     * @throws Exception
     */
    public ILiglPage chooseStakeHolderTemplate(String StakeHolderTemplate)throws Exception{
        try{
            ...
            log_Error("chooseStakeHolderTemplate() is failed");
            throw new Exception("Exception in chooseStakeHolderTemplate() ");
        }
    }
    /**
     * Method to choose a Stake holder questionnaire Template
     * @param StakeHolderQueTemplate
     * @return
     * @throws Exception
     */
    public ILiglPage chooseStakeHolderQuestionnaireTemplate(String StakeHolderQueTemplate)throws Exception{
        try{
            log_Info("chooseStakeHolderQuestionnaireTemplate() Started");
            StakeHolderQuestionaireTemplate.sendKeys(StakeHolderQueTemplate);
            Thread.sleep(3000);
            StakeHolderQuestionaireTemplate.sendKeys(Keys.ENTER);
            log_Pass("Selected StakeHolder Questionaire Template Drop Down");
            return new LegalHoldPage();
        }catch(Exception ex){
            log_Error("chooseStakeHolderQuestionnaireTemplate() is failed");
            throw new Exception("Exception in chooseStakeHolderQuestionnaireTemplate() ");
        }
    }

    /**
     * Method to choose a custodian questionnaire template
     * @param CustodianQuestionaireTemplate
     * @return
     * @throws Exception
     */
