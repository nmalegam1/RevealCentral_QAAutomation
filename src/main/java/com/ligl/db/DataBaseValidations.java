...
public class DataBaseValidations extends DataBaseUtil {
    ...
    public ILiglPage validateCaseApprovalRequest(String intendedUser,String caseType, String caseRole, String caseName, String casePrefix, String caseCreatedDate) throws Exception {
        try {
            //intended-user
    ...
    public ILiglPage checkAllParametersReplacingWithActualValueWhenCaseSendForApprovalRequest() throws Exception {
        try {
            ...
            validateCaseApprovalRequest(getSession().getRegressionData("get_Case_CreatedBy"),
